-- ================================================================
-- _apply_multitenant.sql — 멀티테넌트 + 코드리뷰 + 정합성 통합본 (19~33)
-- Supabase 대시보드 → SQL Editor → 전체 붙여넣기 → Run. 모든 구문 idempotent.
-- ⚠️ super_admin 시드(권한 부여)와 sql/20 의 버킷 비공개 라인은 운영 정책상 사용자가 직접 실행.
-- ================================================================
